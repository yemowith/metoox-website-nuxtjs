...
const getLang = (lang: string) => {
  return locales.value.find((l) => l.code === lang);
};
</script>
...
<template>
  ...
  <div class="hs-dropdown relative inline-flex [--placement:top-left]">
    <button
      ...
      type="button"
      class="hs-dropdown-toggle shadow-2xs focus:outline-hidden bg-lighter border-lighter text-primary inline-flex items-center gap-x-2 rounded-lg border px-3 py-2 text-sm hover:bg-gray-50 focus:bg-gray-50 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
      aria-haspopup="menu"
      aria-expanded="false"
      aria-label="Dropdown"
    >
    ...
    >
      <NuxtLink
        ...
        class="focus:outline-hidden flex items-center gap-x-2 rounded-lg px-3 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
      >
        <svg
          class="size-3 shrink-0 rounded-full"
          xmlns="http://www.w3.org/2000/svg"
