...
<template>
  <div class="bg-neutral-900">
    <!-- ========== HEADER ========== -->
    <header
      class="sticky inset-x-0 top-4 z-50 flex w-full flex-wrap md:flex-nowrap md:justify-start"
    >
      <nav
        class="relative mx-2 w-full max-w-[66rem] rounded-[28px] bg-neutral-800 py-3 pe-2 ps-5 md:flex md:items-center md:justify-between md:py-0 lg:mx-auto"
        aria-label="Global"
      >
        <div class="flex items-center justify-between">
          ...
          <div class="md:hidden">
            <button
              type="button"
              class="hs-collapse-toggle flex size-8 items-center justify-center rounded-full bg-neutral-800 text-sm font-semibold text-white disabled:pointer-events-none disabled:opacity-50"
        ...
        >
          ...
          >
            <a
              class="text-sm text-white hover:text-neutral-300 focus:text-neutral-300 focus:outline-none md:py-4"
              href="../../templates/agency/index.html"
              aria-current="page"
              >Home</a
            >
            ...
            <div
              class="hs-dropdown [--adaptive:none] [--strategy:static] md:py-4 md:[--strategy:fixed]"
            >
              <button
                type="button"
                class="flex w-full items-center text-sm text-white hover:text-neutral-300 focus:text-neutral-300 focus:outline-none"
              >
                About
                <svg
              ...
              <div
                class="hs-dropdown-menu top-full z-10 hidden rounded-lg bg-neutral-800 p-2 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-top-5 before:start-0 before:h-5 before:w-full hs-dropdown-open:opacity-100 md:w-48 md:shadow-md md:duration-[150ms]"
              >
                <a
                  class="flex items-center gap-x-3.5 rounded-lg px-3 py-2 text-sm font-medium text-white hover:text-neutral-300 focus:text-neutral-300 focus:outline-none"
                  href="#"
                >
                  About
                </a>
                <div
                  class="hs-dropdown relative [--adaptive:none] [--strategy:static] md:[--strategy:absolute] md:[--trigger:hover]"
                >
                  <button
                    type="button"
                    class="flex w-full items-center justify-between px-3 py-2 text-sm font-medium text-white hover:text-neutral-300 focus:text-neutral-300 focus:outline-none"
                  >
                    Sub Menu
                    <svg
                  ...
                  <div
                    class="hs-dropdown-menu end-full top-0 z-10 !mx-[10px] hidden rounded-lg bg-neutral-800 p-2 opacity-0 transition-[opacity,margin] duration-[0.1ms] before:absolute before:-end-5 before:top-0 before:h-full before:w-5 hs-dropdown-open:opacity-100 md:mt-2 md:w-48 md:shadow-md md:duration-[150ms]"
                  >
                    <a
                      class="flex items-center gap-x-3.5 rounded-lg px-3 py-2 text-sm font-medium text-white hover:text-neutral-300 focus:text-neutral-300 focus:outline-none"
                      href="#"
            ...
            <div>
              <a
                class="group inline-flex items-center gap-x-2 rounded-full bg-[#ff0] px-3 py-2 text-sm font-medium text-neutral-800 focus:outline-none"
    ...
    <main id="content">
        ...
        <div class="mx-auto max-w-5xl px-4 pb-24 pt-24 lg:pt-32 xl:px-0">
          ...
          <div class="max-w-4xl">
            <p class="mt-5 text-lg text-neutral-400">
              ...
              tangible realities. At Preline Agency, we specialize in turning conceptual visions
              into concrete forms, whether it be through design, artistry, or technological
              innovation.
            </p>
          </div>
        </div>
      ...
      <!-- Clients -->
      <div class="relative overflow-hidden bg-neutral-900 pt-4">
        <svg
        ...
        <div class="relative z-10">
          <div class="mx-auto max-w-5xl px-4 xl:px-0">
            ...
            <div class="flex justify-between gap-6">
              <svg
                class="h-auto w-16 py-3 text-neutral-400 md:w-20 lg:w-24 lg:py-5"
      ...
      <div class="bg-neutral-900 bg-gradient-to-t from-black to-transparent">
        <div class="mx-auto max-w-5xl px-4 py-24 xl:px-0">
          ...
          <div class="mb-10 max-w-3xl lg:mb-14">
            <h2 class="text-2xl font-semibold text-white md:text-4xl md:leading-tight">
              Success stories
            </h2>
            ...
            >
              <div class="mb-5">
                ...
                <div class="mt-5">
                  ...
                  <h3 class="mt-5 text-lg font-medium text-white">
                    Enhancement in Customer Engagement
                  </h3>
                  <p class="mt-1 text-neutral-400">
                    With the aim of optimizing customer interactions and boosting brand loyalty, the
                    team at Preline leveraged Mailchimp's powerful tools and expertise to deliver
                    exceptional results.
                  </p>
                </div>
              </div>
            ...
            >
              <div class="mb-5">
                ...
                <div class="mt-5">
                  ...
                  <p class="mt-1 text-neutral-400">
                    With the goal of accelerating project delivery and enhancing collaboration among
                    development teams, Preline leveraged GitLab's comprehensive suite of tools and
      ...
      <div class="bg-neutral-900">
        <div class="mx-auto max-w-5xl px-4 py-10 lg:py-20 xl:px-0">
          ...
          <div class="mb-10 max-w-3xl lg:mb-14">
            ...
            <p class="mt-1 text-neutral-400">
              With over 30 awards, and achievements, we proudly demonstrate our unwavering
              dedication to excellence and client success.
            </p>
          </div>
          <!-- End Title -->
          ...
          <div class="md:grid md:grid-cols-2 md:items-center md:gap-10 lg:gap-16">
            ...
            <div class="mb-24 hidden md:mb-0 md:block">
              <img
                class="rounded-xl"
      ...
      <div class="bg-neutral-900">
        <div class="mx-auto max-w-5xl px-4 py-10 xl:px-0">
          <div class="rounded-xl border border-neutral-800">
            <div
              class="rounded-xl bg-gradient-to-bl from-neutral-800 via-neutral-900 to-neutral-950 p-4 lg:p-8"
            >
              <div class="grid grid-cols-1 items-center gap-x-12 gap-y-20 sm:grid-cols-3">
                <!-- Stats -->
                <div
                ...
                >
                  <svg
                    class="mx-auto size-6 flex-shrink-0 text-[#ff0] sm:size-8"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <div class="mt-3 sm:mt-5">
                    ...
                    <p class="mt-1 text-sm text-neutral-400 sm:text-base">Preline partners</p>
                  </div>
                </div>
                <!-- End Stats -->
                ...
                >
                  <div class="flex items-center justify-center -space-x-5">
                    <img
                      class="relative z-[2] size-8 flex-shrink-0 rounded-full border-[3px] border-neutral-800"
                    ...
                    />
                    <img
                      class="relative z-[1] -mt-7 size-8 flex-shrink-0 rounded-full border-[3px] border-neutral-800"
                    ...
                    />
                    <img
                      class="relative size-8 flex-shrink-0 rounded-full border-[3px] border-neutral-800"
                  ...
                  <div class="mt-3 sm:mt-5">
                    ...
                    <p class="mt-1 text-sm text-neutral-400 sm:text-base">Happy customers</p>
                  </div>
                </div>
                <!-- End Stats -->
                ...
                >
                  ...
                  <div class="mt-3 sm:mt-5">
                    ...
                    <p class="mt-1 text-sm text-neutral-400 sm:text-base">Ads managed yearly</p>
                  </div>
                </div>
                <!-- End Stats -->
              </div>
      ...
      <div class="bg-neutral-900">
        <!-- Approach -->
        <div class="mx-auto max-w-5xl px-4 py-10 lg:pt-20 xl:px-0">
          <!-- Title -->
          <div class="mb-10 max-w-3xl lg:mb-14">
            <h2 class="text-2xl font-semibold text-white md:text-4xl md:leading-tight">
              Our approach
            ...
            <p class="mt-1 text-neutral-400">
              ...
              strategic planning to the seamless execution of brand development and website or
              product deployment.
            </p>
          </div>
          <!-- End Title -->
          ...
          <div class="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
            ...
            <div>
              <!-- Heading -->
              <div class="mb-4">
                <h3 class="text-xs font-medium uppercase text-[#ff0]">Steps</h3>
              </div>
              <!-- End Heading -->
              ...
              <div class="ms-1 flex gap-x-5">
                <!-- Icon -->
                <div
                  class="relative after:absolute after:bottom-0 after:start-4 after:top-8 after:w-px after:-translate-x-[0.5px] after:bg-neutral-800 last:after:hidden"
                >
                  <div class="relative z-10 flex size-8 items-center justify-center">
                    <span
                      class="flex size-8 flex-shrink-0 items-center justify-center rounded-full border border-neutral-800 text-xs font-semibold uppercase text-[#ff0]"
                    >
                      1
                    </span>
                  </div>
                ...
                <div class="grow pb-8 pt-0.5 sm:pb-12">
                  <p class="text-sm text-neutral-400 lg:text-base">
              ...
              >
                ...
                >
                  ...
                  ></path>
                  <path
                    class="opacity-0 transition group-hover:opacity-100 group-hover:delay-100 group-focus:opacity-100"
                    d="M14.05 2a9 9 0 0 1 8 7.94"
                  ></path>
                  <path
                    class="opacity-0 transition group-hover:opacity-100 group-focus:opacity-100"
          ...
          <div class="grid grid-cols-1 gap-x-10 md:grid-cols-2 lg:gap-x-16">
            ...
            <div class="space-y-14">
              ...
              <div class="flex gap-x-5">
                <svg
                  class="size-6 flex-shrink-0 text-neutral-500"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <div class="flex gap-x-5">
                ...
                <div class="grow">
                  ...
                  <p class="mt-2">
                    <a
                      class="group inline-flex items-center gap-x-2 text-sm font-medium text-[#ff0] decoration-2 hover:underline focus:underline focus:outline-none"
                      href="#"
                    >
                      Job openings
                      <svg
    ...
    <div
      class="fixed bottom-2 end-2 z-[70] ms-2 rounded-lg border border-neutral-800 bg-neutral-900 dark:bg-neutral-800 sm:bottom-4 sm:end-4"
    >
      <!-- Button Group -->
      <div class="flex items-center gap-px">
        <p
          class="relative inline-flex gap-x-2 px-2 py-1 text-xs text-white before:absolute before:-start-0.5 before:top-1/2 before:z-10 before:h-4 before:w-px before:-translate-y-1/2 before:bg-white/20 first:before:hidden"
        >
          <svg
        ...
        <!-- Templates Dropdown -->
        <div
          class="hs-dropdown relative inline-flex [--placement:bottom-right] [--strategy:absolute] before:absolute before:-start-px before:top-1/2 before:z-10 before:h-4 before:w-px before:-translate-y-1/2 before:bg-white/20 first:before:hidden"
        >
          <button
            type="button"
            class="hs-dropdown-toggle inline-flex items-center justify-center gap-x-2 rounded-e-lg border border-transparent bg-neutral-900 px-2 py-2.5 text-xs text-white hover:bg-neutral-950 focus:bg-neutral-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 sm:py-1.5"
          >
            Templates
            <svg
              class="size-3.5 flex-shrink-0 hs-dropdown-open:rotate-180"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <!-- Dropdown -->
          <div
            class="hs-dropdown-menu duration z-10 hidden w-48 rounded-lg border border-neutral-800 bg-neutral-900 opacity-0 shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-neutral-800 dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)]"
          >
            <div class="space-y-0.5 p-1">
              <span class="block p-2 pb-1 text-[11px] uppercase text-gray-400 dark:text-neutral-400"
                >Main Pages</span
              >

              <a
                class="group flex items-center gap-x-1.5 rounded-md px-2 py-1.5 text-[13px] text-gray-200 hover:bg-neutral-800 focus:bg-neutral-800 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                href="../../index.html"
              >
                Preline UI
                <svg
                  class="ms-auto size-3.5 flex-shrink-0 -translate-x-1 opacity-0 transition group-hover:translate-x-0 group-hover:opacity-100"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <div class="border-b border-gray-800 pt-1 dark:border-neutral-700"></div>
              <span class="block p-2 pb-1 text-[11px] uppercase text-gray-400 dark:text-neutral-400"
                >Template Previews</span
              >

              <div
                class="max-h-96 space-y-0.5 overflow-y-auto [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 [&::-webkit-scrollbar-track]:bg-neutral-800 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar]:w-2"
              >
                <a
                  class="active-link group flex items-center gap-x-1.5 rounded-md bg-neutral-800 px-2 py-1.5 text-[13px] text-gray-200 hover:bg-neutral-800 focus:bg-neutral-800 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                  href="../../templates/agency/index.html"
                >
                  Agency
                  <svg
